...
#async def send_notification():
    #channel = app.get_channel(1098896878768234556)  
    #if channel is not None:
        #await channel.send("안녕하세요! 저는 도리봇이에요.")
        #await channel.send("저와 대화를 나누고 싶다면,")
        #await channel.send("'='와 '명령어'를 채팅창에 입력해주세요. :)")
        #await channel.send("======")

#@tasks.loop(hours=72)
#async def send_notification():
    #channel = app.get_channel(944522706894872606)  
    #await channel.send("안녕하세요! 저는 도리봇이에요.")
    #await channel.send("저와 대화를 나누고 싶다면,")
    #await channel.send("'='와 '명령어'를 채팅창에 입력해주세요. :)")
    #await channel.send("======")
...
async def on_ready():
    ...
    #send_notification.start()  # Start the loop
...
async def on_message(message):
    ...
    if message.mentions:
        ...
        embed.set_image(url="https://iili.io/2Qq6hHN.jpg")
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return  # 중단
...
#이모지 크기를 늘려줍니다. / 2025.01.28 수정  
    ...
    if ":01:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWlrG.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return    
    ...
    if ":02:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWaBn.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":03:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqW7LX.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":04:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqW5Xt.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":05:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqW12f.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":06:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWGkl.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":07:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWMp2.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return   
    ...
    if ":08:" in message.content:
        ...
        embed.set_image(url='https://iili.io/3DrZnmN.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":09:" in message.content:
        ...
        embed.set_image(url='https://iili.io/3DrZxII.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":10:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWhQ9.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":11:" in message.content:
        ...
        embed.set_image(url='https://iili.io/3DrZzXt.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":12:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWNEu.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return     
    ...
    if ":13:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWOrb.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":14:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWk2j.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":15:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWvYx.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":16:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqW8kQ.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":17:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWgTB.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return  
    ...
    if ":18:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWrhP.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":19:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqW4Q1.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":20:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWPCF.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":21:" in message.content:
        ...
        embed.set_image(url='https://iili.io/3DUcuPS.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":22:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWs4a.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":23:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWQ3J.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":24:" in message.content:
        ...
        embed.set_image(url='https://iili.io/3DUc5l9.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":25:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWtvR.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":26:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWDpp.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":27:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWmTN.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":28:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWpjI.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":29:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqWyQt.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return   
    ...
    if ":30:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXHCX.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":31:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXJGn.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":32:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXd4s.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return     
    ...
    if ":33:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqX33G.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":34:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXFaf.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":35:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXKv4.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":36:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXfyl.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":37:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXBu2.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return   
    ...
    if ":38:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXCjS.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return 
    ...
    if ":39:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXnZ7.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":40:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXxn9.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":41:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXzGe.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":42:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXI6u.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":43:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXu3b.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":44:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXAaj.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":45:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXR8x.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":46:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqX5yQ.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":47:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXYuV.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":48:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXawB.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":49:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqXcZP.png')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
    ...
    if ":50:" in message.content:
        ...
        embed.set_image(url='https://iili.io/2QqX0n1.jpg')
        embed.set_footer(text=f"도리봇 | {current_time}", icon_url="https://i.imgur.com/Ny6e2BS.jpeg")
        await message.channel.send(embed=embed)
        return
...
#사용자가 봇에게 점을 쳐달라고 요청하는 기능임 / 2023.09.05 수정   
    ...
    if "=허락" in message.content:     
        ...
        if randomNum==1:
            await message.channel.send(embed=discord.Embed(title="오늘은 플레이 해도 좋습니다. 최고의 피지컬을 뽐내보세요.", color=0x00ff00))
        if randomNum==2:
            await message.channel.send(embed=discord.Embed(title="오늘만큼은 플레이하면 후회하실겁니다. 컨디션 최악으로 보입니다만.. 그래도 돌리시겠다면 어쩔수 없죠.", color=0x00ff00))         
     
#서버 내 보겸 관련 키워드 사용을 줄이기 위한 해결책입니다. / 2023.10.27 수정 
 
    if "보이루" in message.content or "보1이루" in message.content or "보11이루" in message.content or "보111이루" in message.content or "ㅂㅇㄹ" in message.content or "ㅂ1ㅇㄹ" in message.content or "ㅂ11ㅇㄹ" in message.content or "ㅂ111ㅇㄹ" in message.content or "ㅂ2ㅇㄹ" in message.content or "ㅂ22ㅇㄹ" in message.content or "ㅂ222ㅇㄹ" in message.content or "ㅂ3ㅇㄹ" in message.content or "ㅂ33ㅇㄹ" in message.content or "ㅂ333ㅇㄹ" in message.content or "ㅂ4ㅇㄹ" in message.content or "ㅂ44ㅇㄹ" in message.content or "ㅂ444ㅇㄹ" in message.content or "ㅂ5ㅇㄹ" in message.content or "ㅂ55ㅇㄹ" in message.content or "ㅂ555ㅇㄹ" in message.content or "ㅂ6ㅇㄹ" in message.content or "ㅂ66ㅇㄹ" in message.content or "ㅂ666ㅇㄹ" in message.content or "ㅂ7ㅇㄹ" in message.content or "ㅂ77ㅇㄹ" in message.content or "ㅂ777ㅇㄹ" in message.content or "ㅂ8ㅇㄹ" in message.content or "ㅂ88ㅇㄹ" in message.content or "ㅂ888ㅇㄹ" in message.content or "ㅂ9ㅇㄹ" in message.content or "ㅂ99ㅇㄹ" in message.content or "ㅂ999ㅇㄹ" in message.content or "ㅂ@ㅇㄹ" in message.content or "ㅂ@@ㅇㄹ" in message.content or "ㅂ@@@ㅇㄹ" in message.content: 
        dtime = datetime.datetime.now(timezone('Asia/Seoul'))
        randomNum = random.randrange(1, 6)
        if randomNum==1:
            await message.channel.send(embed=discord.Embed(title="보이루라는 단어를 사용하지 마십시오.", color=0x00ff00))
        if randomNum==2:
            await message.channel.send(embed=discord.Embed(title="보이루는 혐오표현입니다.", color=0x00ff00))
        if randomNum==3:
            await message.channel.send(embed=discord.Embed(title="보이루는 분란을 조장하는 단어입니다.", color=0x00ff00))
        if randomNum==4:
            await message.channel.send(embed=discord.Embed(title="서버 내 데이터를 분석한 결과, 가장 많은 분란을 조장한 단어로 보이루가 판정되었습니다." ,color=0x00ff00))
        if randomNum==5:
            await message.channel.send(embed=discord.Embed(title="보이루 사용을 지양합시다.", color=0x00ff00))  
 
    if "보겸" in message.content or "보1겸" in message.content or "보11겸" in message.content or "보111겸" in message.content or "보/겸" in message.content or "보//겸" in message.content or "보///겸" in message.content or "보2겸" in message.content or "보22겸" in message.content or "보222겸" in message.content or "보3겸" in message.content or "보33겸" in message.content or "보333겸" in message.content or "보4겸" in message.content or "보44겸" in message.content or "보444겸" in message.content or "보5겸" in message.content or "보55겸" in message.content or "보555겸" in message.content or "보6겸" in message.content or "보66겸" in message.content or "보666겸" in message.content or "보7겸" in message.content or "보77겸" in message.content or "보777겸" in message.content or "보8겸" in message.content or "보88겸" in message.content or "보888겸" in message.content or "보9겸" in message.content or "보99겸" in message.content or "보999겸" in message.content or "보@겸" in message.content or "보@@겸" in message.content or "보@@@겸" in message.content: 
        dtime = datetime.datetime.now(timezone('Asia/Seoul'))
        randomNum = random.randrange(1, 6)
        if randomNum==1:
            await message.channel.send(embed=discord.Embed(title="해당 단어를 사용하지 마십시오.", color=0x00ff00))
        if randomNum==2:
            await message.channel.send(embed=discord.Embed(title="보겸은 혐오표현입니다.", color=0x00ff00))
        if randomNum==3:
            await message.channel.send(embed=discord.Embed(title="보겸은 분란을 조장하는 단어입니다.", color=0x00ff00))
        if randomNum==4:
            await message.channel.send(embed=discord.Embed(title="서버 내 데이터를 분석한 결과, 가장 많은 분란을 조장한 단어로 해당 단어가 판정되었습니다." ,color=0x00ff00))
        if randomNum==5:
            await message.channel.send(embed=discord.Embed(title="해당 단어 사용을 지양합시다.", color=0x00ff00))  
         
#사용자들이 자주 언급한 분란을 조장하는 단어를 제재함 (개선된 버전 / 기존 버전은 유지보수하기 힘드므로, 약간의 개선된 코드를 추가함.) / 2023.10.28 수정 
...
#사용자들이 자주 언급한 분란을 조장하는 단어를 제재함. (기존 버전) / 2024.04.14 수정 
   ...
   #if "좌파" in message.content:
        #await message.delete()
        #await message.channel.send(f"{message.author.mention} 님의 채팅은 분란을 조장합니다.") 

   #if "좌빨" in message.content:
        #await message.delete()
        #await message.channel.send(f"{message.author.mention} 님의 채팅은 분란을 조장합니다.") 

   #if "좌익" in message.content:
        #await message.delete()
        #await message.channel.send(f"{message.author.mention} 님의 채팅은 분란을 조장합니다.") 
     
#욕설을 제재함. (개선된 버전 / 기존 버전은 유지보수하기 힘드므로, 약간의 개선된 코드를 추가함.) / 2023.10.28 수정 
...
#총기 이름에 대응함./ 2023.10.29 수정 
    ...
    if "MG3" in message.content or "mg3" in message.content:
        await message.channel.send(f"{message.author.mention} 님, 제2차 세계 대전 중 독일군의 MG42는 내구성, 다목적성 등 여러 면에서 뛰어난 다목적 기관총이었죠. 완성도가 워낙 높았기에 이를 전후에도 이용하기 위해 독일군은 사용탄을 7.62×51mm NATO탄으로 바꾸고, 너무 높아서 오히려 문제였던 연사력을 분당 1,000발 정도로 떨어뜨린 것만 빼면 MG42와 별 차이가 없는 MG3를 만들었죠. 'brrrrrrrrrr!! 내 앞에서 모두 비켜라! 먼지가 되기 싫다면.'")      
...
#코로나 키워드에 대응함. (2019~2022년) / 2023.08.16 수정 
...
#버전 내용을 불러옵니다. / 2023.09.25 수정함. 

    if message.content.startswith("=버전"):        
        msg = "{0.author.mention} 도리봇은 2023년 10월 29일에 20231029.8 버전으로 업데이트되었어요. 나머지 내용들은 DM을 확인해주세요. 도리봇이 DM을 보내지 않는다면, 한번 더 챗을 치세요.".format(message)
    ...
    if message.content == "=버전":
        if message.author.dm_channel:
            ...
            await message.author.dm_channel.send("제 버전은 231029.8로 가장 최신버전이에요.")
            await message.author.dm_channel.send("이번 업데이트에선 금칙어 시스템을 개선하였어요.")  
            await message.author.dm_channel.send("###############################")            
...
#서버 내 가장 많이 언급된 키워드 분석 결과를 불러옵니다. / 2023.09.04 수정함. 

    if message.content.startswith("=서버분석"):        
        msg = "{0.author.mention} '='와 '서버 이름'을 작성하세요. (예: =삼사모)".format(message)
        await message.channel.send( msg)
     
    if "=배사모" in message.content:
         embed = discord.Embed(
         title='배사모 서버 분석 결과 입니다.',
         description='~2023년 09월 04일',

        )

         urlBase = 'https://i.imgur.com/h3W2FYw.png'
         randomNum = random.randrange(1, 2)
         urlF = urlBase+str(randomNum)
         embed.set_image(url = urlF)
         await message.channel.send( embed=embed)  
     
    if "=아사모" in message.content:
         embed = discord.Embed(
         title='아사모 서버 분석 결과 입니다.',
         description='~2022년 02월 19일',

        )

         urlBase = 'https://i.imgur.com/B7U1LIo.png'
         randomNum = random.randrange(1, 2)
         urlF = urlBase+str(randomNum)
         embed.set_image(url = urlF)
         await message.channel.send( embed=embed)     
