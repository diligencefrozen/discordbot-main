...
banned_patterns = [
    re.compile(r"알[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+람"),   
    re.compile(r"알[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+림"),   
  ...
  # re.compile(r"하남[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+자"), 
    re.compile(r"찬[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+민"),
  ...
  # re.compile(r"군[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+대"), 
    re.compile(r"자[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+삭"), 
...
banned_patterns02 = [
    ...
    re.compile(r"씨[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+발"),   
    re.compile(r"시[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+발"), 
    re.compile(r"병[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+신"),
    re.compile(r"애[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+미"),
    re.compile(r"에[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+미"), 
    re.compile(r"새[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+끼"), 
  # re.compile(r"난[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+교"), 
    re.compile(r"븅[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+신"), 
    re.compile(r"보[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+지"), 
    re.compile(r"ㅅ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅂ"), 
    re.compile(r"ㅆ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅂ"), 
    re.compile(r"ㅂ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅅ"), 
    re.compile(r"ㅇ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅁ"), 
    re.compile(r"한[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+녀"), 
    re.compile(r"애[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+비"), 
  # re.compile(r"에[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+비"), 
    re.compile(r"느[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+금"),  
    re.compile(r"미[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+친"), 
    re.compile(r"존[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+나"), 
    re.compile(r"ㅈ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㄴ"), 
  # re.compile(r"닥[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+치"), 
    re.compile(r"ㄷ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅊ"), 
    re.compile(r"닥[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+쳐"), 
  # re.compile(r"꺼[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+져"), 
    re.compile(r"노[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+무"), 
  # re.compile(r"꺼[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+지"), 
    re.compile(r"ㄲ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㅈ"),  
    re.compile(r"지[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+랄"), 
    re.compile(r"시[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+팔"), 
    re.compile(r"씨[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+팔"), 
    re.compile(r"ㅈ[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㄹ"), 
    re.compile(r"짱[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+깨"),  
  # re.compile(r"이[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+기"), 
    re.compile(r"페[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+미"), 
    re.compile(r"패[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+미"),  
    re.compile(r"장[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+애"), 
    re.compile(r"계[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+집"), 
  # re.compile(r"븅[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+띤"), 
    re.compile(r"정[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+공"), 
  ...
  # re.compile(r"ㅇㄱ[ㄱㄴㄷㄹㅁㅂㅅㅇㅈㅊㅋㅌㅍㅎabcdefghijklmnopqrstuvwxyz1234567890/@!:;#\\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+ㄹ"), 
    re.compile(r"씹[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+놈"),  
    re.compile(r"씹[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+년"), 
    re.compile(r"십[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+놈"),  
    re.compile(r"십[ㄱ-ㅎ가-힣a-zA-Z0-9/@!:;#\s$%^&*()\-_ㅡ=+.,?'\"{}\[\]|`~<> ]+년"),  
    # 여기에 추가적인 패턴들을 넣을 수 있습니다.
]
